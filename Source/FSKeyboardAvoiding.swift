//
//  FSKeyboardAvoiding.swift
//  FSKeyboardAvoiding
//
//  Created by Felipe de Sousa Silva on 06.07.18.
...
@objc
public class KeyboardAvoiding: NSObject {
  ...
  public static var avoidingBlock: ((Bool, CGFloat, CGFloat, UIViewAnimationOptions) -> Void)? {
    ...
    didSet {
      if self.triggerViews.isEmpty && self.avoidingBlock != nil {
  ...
  private class func setAvoidingView(_ avoidingView: UIView?, withOptionalTriggerView triggerView: UIView?) {
    ...
    self.avoidingViewUsesAutoLayout = (avoidingView != nil && avoidingView!.superview != nil) ? !avoidingView!.superview!.constraints.isEmpty : false
  ...
  private class func initialise() {
    ...
    if self.avoidingBlock == nil && self.avoidingView == nil {
      NotificationCenter.default.addObserver(forName: NSNotification.Name.UIApplicationDidEnterBackground, object: nil, queue: OperationQueue.main, using: { _ in
